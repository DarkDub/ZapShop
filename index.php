...
<html lang="en">
    <head>
        ...
        <style>
            header{
                background: linear-gradient(rgba(5, 7, 12, 0.75), rgba(5, 7, 12, 0.75)), url('images/zap2.jpg');
...
<!--  -->
     <nav class="navbar navbar-expand-lg navbar-light bg-light py-3">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">ZapShop</a>
                    ...
                    <div class="row gx-5 align-items-center justify-content-center py-5">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-5 fw-bolder text-white mb-2">¡Bienvenido a ZapShop el lugar perfecto para calzados!</h1>
                                <p class="lead fw-normal text-white-50 mb-4">¡Bienvenidos a Zapshop, tu destino número uno para calzado de moda y comodidad! Estamos encantados de recibirte en nuestra tienda, donde encontrarás una amplia selección de zapatos para satisfacer todos tus gustos y necesidades.</p>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a class="btn btn-outline-light btn-lg px-4 me-sm-3" href="catalogo.php">Explorar!</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="images/zap2.jpg" alt="..." /></div>
                    </div>
                </div>
            </header>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card text-white bg-secondary my-5 py-4 text-center">
                <div class="card-body"><p class="text-white m-0">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure facere nulla quaerat velit architecto? Iure est maxime qui dolore sunt, repellendus quis velit quidem!</p></div>
            </div>
            <!-- Content Row-->
